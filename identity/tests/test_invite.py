"""Person creation and the credential lifecycle status it sets (issue #482, ADR 0018)."""
...
def person_args():
    """Build a fresh, fake (name, email) kwargs dict for calling create_person_with_temp_password in tests."""
