...
# cast tables independently of each group's name. `key` is the stable machine
# identifier `services.default_role_group_for()` looks a seeded group up by, so
# renaming `name` in admin later can't break that lookup.
SEED_GROUPS = [
    {'name': 'Vocals', 'key': 'vocals', 'display_order': 0, 'is_catch_all': False},
    {'name': 'Guitars', 'key': 'guitars', 'display_order': 1, 'is_catch_all': False},
    {'name': 'Bass', 'key': 'bass', 'display_order': 2, 'is_catch_all': False},
    {'name': 'Drums', 'key': 'drums', 'display_order': 3, 'is_catch_all': False},
    {'name': 'Keyboards', 'key': 'keyboards', 'display_order': 4, 'is_catch_all': False},
    {'name': 'Saxophone', 'key': 'saxophone', 'display_order': 5, 'is_catch_all': False},
    {'name': 'Trumpet', 'key': 'trumpet', 'display_order': 6, 'is_catch_all': False},
    {'name': 'Violin', 'key': 'violin', 'display_order': 7, 'is_catch_all': False},
    {'name': 'Other', 'key': 'other', 'display_order': 8, 'is_catch_all': True},
]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.SlugField(editable=False, max_length=255, unique=True)),
